...
interface MirrorRateMySongIntroLiteProps {
  gameState: GameState;
  profileName: string;
...
export function MirrorRateMySongIntroLite({ gameState, onSendDesktopCommand }: MirrorRateMySongIntroLiteProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-6 px-4 py-12">
      ...
      <h2 className="text-xl font-bold text-white text-center">
        {t('rateMySong.title') || 'Rate My Song'}
      </h2>
      ...
      >
        ▶ {t('rateMySong.start') || 'Singen starten'}
      </button>
    </div>
  );
}

MirrorRateMySongIntroLite.displayName = 'MirrorRateMySongIntroLite';
