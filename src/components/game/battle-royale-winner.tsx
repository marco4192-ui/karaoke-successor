...
interface BattleRoyaleWinnerProps {
  game: BattleRoyaleGame;
  sortedPlayers: BattleRoyalePlayer[];
  onEndGame: () => void;
}

export function BattleRoyaleWinner({ game, sortedPlayers, onEndGame }: BattleRoyaleWinnerProps) {
    ...
    <div className="max-w-5xl mx-auto text-center">
      <div className="bg-gradient-to-r from-amber-500/30 to-yellow-500/30 border-2 border-amber-500 rounded-xl p-12">
        ...
        <div className="flex items-center justify-center gap-4 mb-6">
          ...
          <Badge
            className={`${
              game.winner.playerType === 'microphone'
        ...
        <div className="text-xl text-white/60 mb-8">
          ...
          <span className="text-amber-400 font-bold">
            {game.winner.score.toLocaleString()}
          </span>
        </div>
        <Button
          onClick={onEndGame}
