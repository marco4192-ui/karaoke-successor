...
interface BattleRoyaleEliminationProps {
  eliminatedPlayer: BattleRoyalePlayer | undefined;
  remainingCount: number;
}

export function BattleRoyaleElimination({
  eliminatedPlayer,
  remainingCount,
}: BattleRoyaleEliminationProps) {
      ...
      <div className="bg-gradient-to-r from-red-500/30 to-pink-500/30 border-2 border-red-500 rounded-xl p-12">
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-white/40 text-lg">
            ...
            <span className="text-red-400 font-bold">
              {eliminatedPlayer.score?.toLocaleString()}
            </span>
          </p>
        ...
        <div className="mt-6 pt-4 border-t border-white/10">
          <p className="text-white/60">
            <span className="text-amber-400 font-bold">{remainingCount}</span> players
            remaining
          </p>
        </div>
      </div>
