...
/**
 * PlayerCard - Card component for displaying a Battle Royale player
 * Shows profile picture, name, score, and player type indicator
 */
...
export function PlayerCard({ player, rank, isLeading }: PlayerCardProps) {
