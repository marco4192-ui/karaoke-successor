...
export interface PracticePanelProps {
  ...
  onPracticeModeChange: (_config: Partial<PracticeModeConfig>) => void;
}
  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed bottom-32 right-4 z-30 w-12 h-12 rounded-full flex items-center justify-center transition-all ${
      ...
      {showControls && (
        <div className="fixed bottom-48 right-4 z-30 w-72 bg-gray-800/95 rounded-xl p-4 border border-white/20">
