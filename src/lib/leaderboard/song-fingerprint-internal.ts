/**
 * Internal SHA-256 implementation — shared by song-fingerprint and anti-cheat-proof.
 * NOT part of the public API. Import only from within the leaderboard/ directory.
 */

/**
 * Synchronous SHA-256 — minimal JS implementation.
