...
jukeboxPlayer: {
  ...
  filterByGenre: 'Filtrera efter Genre',
  filterByArtist: 'Filtrera efter Artist',
  filterByEra: 'Filtrera efter Era',
  allEras: 'Alla eror',
  shuffle: 'Blanda',
  ...
  playlist: 'Spellista',
  allSongs: 'Alla låtar',
  selectPlaylist: 'Välj en spellista för att filtrera låtar',
  ...
  allYears: 'Alla År',
  // ── Sökförslag (fuzzy-rankning) ──
  searchSuggestions: 'Förslag',
  searchNoMatches: 'Inga träffar',
  addToPlaylist: 'Lägg till i spellistan',
  addAllToPlaylist: 'Lägg till alla ({n})',
  addedToPlaylist: 'Tillagd i spellistan!',
  addedNToPlaylist: '{n} låtar tillagda i spellistan!',
  alreadyInPlaylist: 'Redan i spellistan',
  // ── Ett fält för videolänkar (en eller flera) ──
  videoLinksTitle: 'Videolänkar',
  videoLinksDesc: 'En eller flera länkar — en per rad — spelas i följd',
  videoLinksPlaceholder: 'En länk per rad — valfritt med titel: https://… | Min titel',
  videoLinksAdd: 'Lägg till',
  videoLinksSupported: 'Alla stora videoplattformar stöds:',
  videoLinksSimpleHint: 'Klistra bara in länken',
  videoLinksVkNote: '(för VK Video krävs inbäddningskoden)',
  videoLinksFileTypes: 'Filer som stöds: TXT, CSV, TSV, M3U/M3U8, MD, LOG',
},
songPool: 'Låtpool',
songPoolSelect: 'Välj en låtpool för att filtrera låtar',
switchPool: 'Byt pool',
jukeboxA11y: {
...
fullscreen: {
  exitF12: 'Avsluta helskärn (F12)',
  toggleF12: 'Växla helskärn (F12)',
  exitEsc: 'Avsluta helskärn (ESC)',
  enter: 'Helskärmsläge',
},
errorBoundary: {
