...
jukeboxPlayer: {
  ...
  playlist: 'プレイリスト',
  allSongs: '全曲',
  selectPlaylist: 'プレイリストを選んで曲を絞り込む',
  ...
  addAllToPlaylist: 'すべて追加 ({n})',
  addedToPlaylist: 'プレイリストに追加しました！',
  addedNToPlaylist: '{n}曲をプレイリストに追加しました！',
  alreadyInPlaylist: 'すでにプレイリストにあります',
  // ── 動画リンク用の統合フィールド（1つまたは複数） ──
  videoLinksTitle: '動画リンク',
  videoLinksDesc: '1つまたは複数のリンク（1行に1つ）を連続再生',
  videoLinksPlaceholder: '1行に1つのリンク — タイトル付きも可: https://… | タイトル',
  videoLinksAdd: '追加',
  videoLinksSupported: '主要な動画プラットフォームすべてに対応:',
  videoLinksSimpleHint: 'リンクを貼り付けるだけ',
  videoLinksVkNote: '（VK Videoには埋め込みコードが必要です）',
  videoLinksFileTypes: '対応ファイル: TXT, CSV, TSV, M3U/M3U8, MD, LOG',
},
songPool: 'ソングプール',
...
dailyChallenge: {
  badges: {
    firstChallenge: {
      name: 'ファーストステップ',
      description: '初めてのデイリーチャレンジを完了',
    },
    weekWarrior: {
      name: 'ウィークウォリアー',
      description: '7日間のストリークを維持',
    },
    fortnightFighter: {
      name: 'フォートナイトファイター',
      description: '14日間のストリークを維持',
    },
    monthlyMaster: {
      name: 'マンスリーマスター',
      description: '30日間のストリークを維持',
    },
    podiumFinish: {
      name: '表彰台',
      description: 'デイリーチャレンジでトップ3に入る',
    },
    dailyChampion: {
      name: 'デイリーチャンピオン',
      description: 'デイリーチャレンジで優勝',
    },
    dedicatedSinger: {
      name: '熱心な歌手',
      description: '30のデイリーチャレンジを完了',
    },
    legendaryStatus: {
      name: '伝説のステータス',
      description: '合計10,000 XPに到達',
    },
    centuryChampion: {
      name: 'センチュリーチャンピオン',
      description: '100日間のストリークを維持',
    },
    yearlyLegend: {
      name: '年間レジェンド',
      description: '365日間のストリークを維持',
    },
  },
  quests: {
    dailyDouble: {
      name: 'デイリーダブル',
      description: '今日2つのデイリーチャレンジを完了',
    },
    perfectTen: {
      name: 'パーフェクトテン',
      description: '合計10回パーフェクトノートをヒット',
    },
    challengeExplorer: {
      name: 'チャレンジエクスプローラー',
      description: '5つの異なるチャレンジモードをプレイ',
    },
    songbird: {
      name: 'ソングバード',
      description: '合計10曲を完了',
    },
    weeklyWarrior: {
      name: 'ウィークリーウォーリアー',
      description: '3つのウィークリーチャレンジを完了',
    },
  },
  streakMilestones: {
