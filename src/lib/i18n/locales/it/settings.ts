...
settings: {
  ...
  noteDisplaySealedDesc: 'Il laser incide il colore nella nota — gli errori appaiono rossi all’altezza davvero cantata',
  ...
  sealedHitColorDesc: 'Colore che il laser incide nelle note',
