...
settings: {
  ...
  noteColorProfileDesc: 'Scegli una tavolozza di colori per le barre delle note durante il gioco',
...
settingsGraphicSound: {
  ...
  noteStyleTrail: 'Effetto scia',
  noteStyleTrailDesc: 'Scia colorata dietro la nota',
  noteStyleRetroBars: 'Barre retro',
  noteStyleRetroBarsDesc: 'Barre arcade classiche',
  noteStyleParticleFade: 'Dissolvenza a particelle',
  noteStyleParticleFadeDesc: 'Le note si dissolvono in particelle',
  ...
  shapeMusicNote: 'Nota musicale',
  shapeMusicNoteDesc: '♪ Forma nota musicale',
  shapeStar: 'Stella',
  shapeStarDesc: 'Forma a stella',
  shapeCircle: 'Cerchio',
  shapeCircleDesc: 'Forma rotonda',
  shapeHexagon: 'Esagono',
  shapeHexagonDesc: 'Forma esagonale',
  shapeTriangle: 'Triangolo',
  shapeTriangleDesc: 'Freccia che punta a sinistra',
...
webcamSettings: {
  ...
  appearance: {
    themeNeonNights: 'Notti Neon',
    themeRetroArcade: 'Arcade Retro',
    themeSunsetVibes: 'Vibes del Tramonto',
