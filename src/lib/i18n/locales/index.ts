// Translation data for Karaoke Successor
...
const esTranslations = {
  ...
  home: { title: 'Karaoke Successor', subtitle: 'La experiencia de karaoke definitiva. ¡Canta con detección de tono en tiempo real, compite con amigos y disfruta de los juegos de fiesta!', startSinging: 'Empezar a Cantar', partyMode: 'Modo Fiesta', songsAvailable: 'Canciones Disponibles', profilesCreated: 'Perfiles Creados', partyGames: 'Juegos de Fiesta', difficultyLevels: 'Niveles de Dificultad', selectProfile: 'Selecciona tu Perfil', createNew: 'Crear Nuevo' },
