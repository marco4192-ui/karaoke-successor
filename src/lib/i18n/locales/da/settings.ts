...
settings: {
  ...
  noteDisplaySealedDesc: 'Laseren brænder farven ind i noden — fejl vises rødt ved den tonhøjde, du faktisk sang',
  noteDisplayExact: 'Nøjagtig',
  noteDisplayExactDesc: 'Fast 5-farvekode efter kvalitet',
  sealedHitColor: 'Rammefarve',
  sealedHitColorDesc: 'Farve som laseren brænder ind i noderne',
