...
settings: {
  ...
  aiProvider: {
    title: 'KI-Dienst',
    desc: 'KI-Backend für Harmonisieren, Metadaten, Song-Erkennung und Cover-Generierung',
    custom: 'Eigener Endpunkt (OpenAI-kompatibel)',
    zaiHint: 'Der eingebaute Z.ai-Dienst benötigt eine .z-ai-config Datei auf dieser Maschine. Alternativ kannst du einen eigenen OpenAI-kompatiblen Endpunkt hinterlegen (OpenAI, OpenRouter, LM Studio, Ollama u. a.).',
    baseUrl: 'Base-URL',
    apiKey: 'API-Key',
    model: 'Modell',
    modelHint: 'z. B. gpt-4o-mini — wird für Chat und Bilder verwendet',
    statusAvailable: 'KI-Dienst verfügbar ({provider})',
    statusUnavailable: 'KI-Dienst aktuell nicht erreichbar',
    saveAndTest: 'Speichern & testen',
    saveOnly: 'Nur speichern',
    saved: '✓ Konfiguration gespeichert',
    saveFailed: 'Speichern fehlgeschlagen',
    testOk: '✓ Verbindung erfolgreich — KI-Dienst antwortet',
    testFailed: 'Verbindungstest fehlgeschlagen',
    privacyHint: 'Die Konfiguration wird lokal in ai-provider.json neben dem Server gespeichert. Anfragen gehen direkt an den gewählten Endpunkt.',
  },
  ...
  onlineActivities: 'Online-Aktivitäten',
  onlineActivitiesDesc: 'Alle Online-Features deaktivieren inkl. Leaderboard, Daily Challenges und Profil-Sync',
  disableOnline: 'Online-Aktivitäten deaktivieren',
  disableOnlineDesc: 'Wenn deaktiviert, werden keine Daten an externe Server gesendet. Alle Funktionen arbeiten offline.',
  ...
  noteDisplaySealedDesc: 'Der Laser brennt die Farbe in die Noten — Fehlversuche erscheinen rot auf der tatsächlich gesungenen Tonhöhe',
  noteDisplayExact: 'Exakt',
  noteDisplayExactDesc: 'Festes 5-Farb-System nach Trefferqualität',
  sealedHitColor: 'Treffer-Farbe',
  sealedHitColorDesc: 'Farbe, die der Laser in die Noten brennt',
...
settingsAbout: {
  ...
  platformOs: 'Betriebssystem',
  platformArch: 'Architektur',
  platformNode: 'Gebündeltes Node.js',
  platformOnnx: 'ONNX Runtime (CREPE)',
  platformServer: 'Lokaler Server',
  platformReady: 'Bereit',
  platformMissing: 'Nicht gefunden',
  platformMissingHint: 'Einige native Funktionen sind möglicherweise nicht verfügbar.',
},
webcamSettings: {
...
syncBackup: {
  ...
  includeMediaDesc: 'Vollständig eigenständige Backup-Datei — wird allerdings deutlich größer.',
  exportButton: '💾 Backup erstellen & herunterladen',
  exporting: 'Backup wird erstellt…',
  exportSuccess: 'Backup heruntergeladen!',
  exportError: 'Backup konnte nicht erstellt werden.',
  restoreTitle: 'Backup wiederherstellen',
  restoreDesc: 'Backup-Datei vom anderen Gerät auswählen, Inhalt prüfen und auf diesem Gerät zusammenführen. Vorhandene Fortschritte gehen nicht verloren — Profile, Songs und die besten Highscores werden zusammengeführt.',
  chooseFile: 'Backup-Datei auswählen…',
  invalidFile: 'Diese Datei ist kein gültiges Karaoke-ZERO-Backup.',
  previewTitle: 'Backup-Inhalt:',
  restoreMediaToggle: 'Song-Medien wiederherstellen (IndexedDB)',
  restoreSettingsToggle: 'Einstellungen ebenfalls übernehmen (Theme, Sprache, Gameplay-Optionen)',
  restoreButton: '📥 Wiederherstellen',
  restoring: 'Wird wiederhergestellt…',
  restoreSuccess: 'Wiederherstellen abgeschlossen!',
  restoreError: 'Wiederherstellen fehlgeschlagen.',
  reloadHint: 'Seite neu laden, damit die wiederhergestellten Songs und Medien erscheinen.',
  summaryProfiles: '{n} Profile',
  summarySongs: '{n} Songs',
  summaryPlaylists: '{n} Playlists',
  summaryHighscores: '{n} Highscore-Einträge',
  summaryMedia: '{n} Medien ({size})',
  howTitle: 'So funktioniert der Geräte-Transfer',
  howPoint1: 'Auf dem Quell-Gerät: Backup erstellen (mit oder ohne Song-Medien) und die Datei auf das Ziel-Gerät übertragen (USB, Cloud-Ordner, Messenger — die Datei verlässt deine Hand nur, wenn du sie selbst sendest).',
  howPoint2: 'Auf dem Ziel-Gerät: Backup-Datei hier auswählen und wiederherstellen.',
  howPoint3: 'Gerätegebundene Einstellungen (Mikrofon-Geräte, Companion-Registrierung, Songs-Ordner-Pfade) werden bewusst NICHT übernommen — die gelten pro Gerät.',
  howPoint4: 'Highscores werden weise zusammengeführt: pro Song und Spieler zählt immer der bessere Lauf — auf beiden Geräten.',
},
};
