...
export const mobileTranslations = {
  mobile: {
    ...
    mirrorSetupDesktopHint: 'Spieler-Auswahl auf dem Desktop',
    mirrorSetupDesktopHintDesc: 'Wähle Spieler und Einstellungen auf dem Desktop-Bildschirm.',
    mirrorSongVoting: 'Song-Abstimmung',
    mirrorSongVotingHint: 'Stimme auf dem Desktop ab',
    mirrorSongVotingDesc: 'Die Song-Auswahl findet auf dem Desktop-Bildschirm statt.',
    mirrorLibrary: 'Bibliothek',
    mirrorSearchSongs: 'Suche...',
    mirrorNoSongs: 'Keine Songs gefunden',
  ...
  desktopChat: {
    ...
    acceptChallenge: 'Akzeptieren',
    challengeDuel: 'Duell-Herausforderung',
    challengeDuet: 'Duet-Herausforderung',
    from: 'von',
  ...
  achievements: {
    firstSong: { title: 'Erste Schritte', description: 'Sing dein erstes Lied' },
    risingStar: { title: 'Aufsteigender Stern', description: 'Sing 10 Lieder' },
    veteran: { title: 'Veteran', description: 'Sing 50 Lieder' },
    perfectionist: { title: 'Perfektionist', description: 'Erreiche eine perfekte Bewertung (95%+)' },
    flawless: { title: 'Makellos', description: 'Erreiche 5 perfekte Bewertungen' },
    scoreMaster: { title: 'Punkte-Meister', description: 'Erreiche 10.000 Gesamt-Punkte' },
    playlistBuilder: { title: 'Playlist-Erbauer', description: 'Reihe 5 Lieder in die Warteschlange' },
    genreExplorer: { title: 'Genre-Entdecker', description: 'Sing Lieder aus 3 Genres' },
  },
};