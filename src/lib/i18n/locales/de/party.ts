...
companionSingalong: {
  ...
  introDescription: 'Alle singen über ihr Handy — wenn es aufleuchtet, bist du dran!',
},
matchAbort: {
...
competitiveWords: {
  ...
  winner: 'Gewinner!',
  tieTitle: 'Unentschieden!',
  tieSubtitle: 'Beide Sänger teilen den Top-Score — die Krone geht an niemanden.',
  points: '{n} Punkte',
...
battleRoyale: {
  ...
  showdownLabel: 'Stechen!',
  showdownAria: 'Stechen — Entscheidung in {n} Sekunden',
  coinFlipEliminated: 'Münzwurf! {name} ist ausgeschieden!',
  coinFlipBadge: 'Münzwurf',
...
unifiedSetup: {
  ...
  singingDeviceAssignment: 'Singing Device Assignment',
  singingDeviceAssignmentDesc: 'Wähle pro Spieler: Singen per Mikrofon oder Companion-App.',
  deviceChooseMic: '— Mikrofon wählen —',
  ...
  deviceMultiMicHint: 'Duell-Modus: {n} Mikrofone erkannt — duellierende Spieler teilen sie, kein festes Mikro pro Spieler.',
  deviceSingleMicHint: 'Nur ein Mikrofon angeschlossen — weise es einem Spieler zu; alle anderen benötigen die Companion-App.',
  deviceNoMicsHint: 'Kein Mikrofon angeschlossen — alle Spieler müssen per Companion-App singen.',
  deviceNeedSharedMic: 'Wähle das gemeinsame Mikrofon, um zu starten',
  deviceNeedAllCompanion: 'Alle Spieler müssen per Companion-App verbunden sein, um zu starten',
  deviceNeedExclusive: '{n} Spieler benötigen noch ein Gerät — freies Mikro zuweisen oder Companion-App verbinden',
  ...
  clickSongToSelect: 'Klicke auf einen Song, um ihn für deine Party auszuwählen — gestartet wird über „Bereit zum Spielen“.',
  songTooShortCptm: 'Song zu kurz für Companion Sing-A-Long.',
...
partyHistory: {
  title: 'Letzte Partys',
  empty: 'Noch keine Partys — spiel ein Spiel und die Ergebnisse erscheinen hier',
  winner: 'Sieger',
  players: '{n} Spieler',
  rounds: '{n} Runden',
  playerSingular: '{n} Spieler',
  roundSingular: '{n} Runde',
  timesPlayed: '{n}× gespielt',
  clear: 'Leeren',
  confirmClear: 'Sicher?',
  totalParties: 'Partys gesamt',
  favoriteMode: 'Lieblingsmodus',
  topWinner: 'Häufigster Sieger',
...
extendedDesc: {
  ...
  battleRoyale: ['🎤 Bis zu 4 Spieler mit Mikrofon am Gerät', '📱 Bis zu 20 weitere Spieler über die Companion App', '📉 Der Spieler mit der niedrigsten Punktzahl scheidet aus', '🔄 Jede Runde ein neuer Song (oder per Abstimmung)', '⚔️ Bei Gleichstand: 10s Stechen — dann entscheidet der Münzwurf!', '🏆 Grand Finale: Best-of-3 oder Best-of-5 für die letzten 2', '👑 Der letzte Sänger gewinnt!'],
...
modeSettings: {
  ...
  brEliminationInterval: 'Ausscheide-Intervall',
  brEliminationIntervalDesc: 'Der schwächste Spieler scheidet alle {n} Sekunden aus (Zufall/Abstimmung). Im Medley: Runden-Budget aus 30-s-Snippets.',
  ...
  finalRoundDurationDesc: 'Länge der Final-Runde (letztes Duell bzw. Grand-Finale-Runden).',
  medleyMode: 'Medley-Modus',
  medleyModeDesc: 'Mehrere Song-Snippets pro Runde',
  normalFinal: 'Normal',
  bestOf3: 'Best of 3',
  ...
  missingWordFrequencyDesc: 'Wie viel Text versteckt wird',
  missingGranularity: 'Versteck-Modus',
  missingGranularityDesc: 'Wörter, Passagen oder beides',
  bestOf: 'Best of',
  bestOfDesc: 'Anzahl Runden pro Spieler',
  blindFrequency: 'Blind-Frequenz',
  blindFrequencyDesc: 'Wie oft Passagen blind werden',
  grandFinale: 'Großes Finale',
  grandFinaleDesc: 'Format der letzten 2 Spieler',
},
gameModes: {
  passTheMic: {
    title: 'Reich das Mikro',
    description: 'Wechsle dich beim Singen ab!',
  },
  companionSingalong: {
    title: 'Companion Sing-A-Long',
    description: 'Dein Handy leuchtet zufällig auf — sing wenn es blinkt!',
  },
  medley: {
    title: 'Medley Contest',
    description: 'FFA oder Team-Modus — singe zufällige Song-Snippets!',
  },
  tournament: {
    title: 'Turnier-Modus',
    description: 'Einfache Elimination — Sudden Death!',
  },
  battleRoyale: {
    title: 'Battle Royale',
    description: 'Alle singen zusammen — der schlechteste Score scheidet jede Runde aus! Bis zu 24 Spieler (4 Mikrofon + 20 Companion)',
  },
  duel: {
    title: 'Duell-Modus',
    description: 'Zwei Spieler treten gegeneinander an!',
  },
  blind: {
    title: 'Blindes Karaoke',
    description: 'Musikalische Passagen werden blind! Solo, Kooperativ oder Kompetitiv.',
  },
  missingWords: {
    title: 'Fehlende Wörter',
    description: 'Wörter oder Passagen verschwinden! Solo, Kooperativ oder Kompetitiv.',
  },
  rateMySong: {
    title: 'Bewerte meinen Song',
    description: 'Singe einen Song und lass Freunde deine Leistung bewerten!',
  },
},
};
