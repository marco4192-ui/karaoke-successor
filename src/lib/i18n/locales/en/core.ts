...
export const coreTranslations = {
  ...
  homeScreen: {
    ...
    challengeLoading: 'Loading challenges...',
    dailyProgress: '{done} of {total} slots',
    slotLabel: 'Slot {n}',
    resetIn: 'Resets in {time}',
    dailyCta: 'Start Daily',
    weeklyCta: 'View Weekly',
    allDailyDone: 'All daily slots completed! 🎉',
    allWeeklyDone: 'All weekly slots completed! 🎉',
    xpReward: '+{xp} XP',
    needProfileTitle: 'Profile required',
    needProfileDesc: 'Create a player profile to track daily and weekly challenges, earn XP and unlock badges.',
    needProfileCta: 'Create Profile',
    // Navigation cards
    navSectionTitle: 'Explore the app',
    navSoloTitle: 'Solo Singing',
    navSoloDesc: 'Pick a song from the library and start singing',
    ...
    navHighscoresDesc: 'Highscores and records',
    navAchievementsTitle: 'Achievements',
  ...
  jukeboxPlayer: {
    ...
    playlist: 'Playlist',
    allSongs: 'All Songs',
    selectPlaylist: 'Select a playlist to filter songs',
    ...
    artistsAvailable: 'Artists',
    vinylLabel: 'Spinning vinyl record',
    equalizerLabel: 'Audio visualization',
    heroTagline: 'Music only – no scores, no pressure. Just enjoy.',
    youtubeShort: 'YouTube link',
    playbackOptions: 'Playback options',
    addYoutubeHint: 'Copy a link from YouTube and paste it here',
    startReady: 'Ready to play',
    ...
    linkListPlaceholder: 'https://… (one link per line)\nOptional title: https://… | My title',
    linkListAdd: 'Queue list',
    linkListFile: 'File',
    linkListParsed: '{n} links detected',
    linkListQueued: '{n} videos queued!',
    // ── Library playlist directly in the jukebox ──
    enqueuePlaylist: 'Play playlist',
    ...
    songPool: 'Song Pool',
    songPoolSelect: 'Select a song pool to filter songs',
  ...
  dailyBadges: {
    ...
    songChallenge: {
      ...
      cannotAcceptOwn: 'You cannot accept your own challenge',
    },
    difficulty: {
      easy: 'Easy',
      medium: 'Medium',
