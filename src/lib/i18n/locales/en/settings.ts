...
export const settingsTranslations = {
  settings: {
    ...
    aiProvider: {
      title: 'AI Service',
      desc: 'AI backend for harmonization, metadata, song identification and cover generation',
      custom: 'Custom endpoint (OpenAI-compatible)',
      zaiHint: 'The built-in Z.ai service requires a .z-ai-config file on this machine. Alternatively you can configure any OpenAI-compatible endpoint (OpenAI, OpenRouter, LM Studio, Ollama, …).',
      baseUrl: 'Base URL',
      apiKey: 'API key',
      model: 'Model',
      modelHint: 'e.g. gpt-4o-mini — used for chat and images',
      statusAvailable: 'AI service available ({provider})',
      statusUnavailable: 'AI service currently unreachable',
      saveAndTest: 'Save & test',
      saveOnly: 'Save only',
      saved: '✓ Configuration saved',
      saveFailed: 'Saving failed',
      testOk: '✓ Connection successful — AI service responding',
      testFailed: 'Connection test failed',
      privacyHint: 'The configuration is stored locally in ai-provider.json next to the server. Requests go directly to the selected endpoint.',
    },
    ...
    noteDisplaySealedDesc: 'The laser burns the colour into the note — misses show red at the pitch you actually sang',
    noteDisplayExact: 'Exact',
    noteDisplayExactDesc: 'Fixed 5-colour code by hit quality',
    sealedHitColor: 'Hit Colour',
    sealedHitColorDesc: 'Colour the laser burns into hit notes',
  ...
  settingsLibrary: {
    ...
    importSongs: 'Import from other karaoke systems',
    importSongsDesc: 'Convert songs from other systems (MIDI/KAR, Karaoke Mugen .ass/.json, SingStar, StepMania) into the UltraStar format — import full UltraStar libraries via the songs folders above.',
