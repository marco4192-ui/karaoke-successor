...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .setup(|app| {
            ...
            // error page.  We write a minimal splash HTML to a temp file
            // and navigate to it via file:// so the user sees a branded
            // loading screen.  data: URIs are blocked by CSP and
            // tauri.localhost doesn't serve frontendDist in dev mode.
