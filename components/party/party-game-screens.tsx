  ...
  useEffect(() => {
    ...
    if (micOverlay.countdown <= 0) {
      ...
      const setupResult: GameSetupResult = {
        ...
        settings: { difficulty: 'medium', filterGenre: 'all', filterLanguage: 'all', filterCombined: true, filterReleaseYear: 'all' },
        ...
        <CompetitiveGameView
          ...
          onPlayMatch={(p1Id, p2Id, p1Name, p2Name, song) => {
            ...
            const setupResult: GameSetupResult = {
              ...
              settings: { difficulty: comp.settings.difficulty, filterGenre: 'all', filterLanguage: 'all', filterCombined: true, filterReleaseYear: 'all' },
              songSelection: 'random',
